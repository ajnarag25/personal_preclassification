...
<form method="POST" action="FORM2_A.php">
    ...
    <table>
        ...
        <tr>
            ...
            <td><input type="text"></td>
            <td><input type="date"></td>
            <td><input id="CA_FS_1" readonly type="text"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text"></td>
            <td><input type="date"></td>
            <td><input id="CA_FS_2" readonly type="text"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input type="text"></td>
            <td><input type="date"></td>
            <td><input id="CA_FS_4" readonly type="text"></td>
        </tr>

        <tr>
            <td colspan="5"></td>
            <td>
                <button type="button" onclick="calcu_FS__CA()">Calculate</button>
            </td>
            <td>Total:</td>
    ...
    <table>
        ...
        <tr>
            ...
            <td><input id="LR_FS_1" id="" readonly type="text"></td>
        </tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="4"></td>
            <td>
                <button type="button" onclick="cont_asdasd()">Calculate</button>
            </td>
            <td>Total:</td>
