...
function cont_asdasd()
{
  ...
  const cont9 = document.getElementById('cont9');
  ...
  const cont15 = document.getElementById('cont15');
  const cont_re3 = document.getElementById('cont_res__3')
  ...
  const cont16 = document.getElementById('cont16');
  const cont17 = document.getElementById('cont17');
  const cont18 = document.getElementById('cont18');
  const cont19 = document.getElementById('cont19');
  const cont20 = document.getElementById('cont20');
  const cont_res4 = document.getElementById('cont_res__2')
